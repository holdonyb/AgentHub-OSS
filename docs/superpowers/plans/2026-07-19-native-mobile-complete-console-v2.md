...
- [x] **Step 1: Create realistic fixtures**
...
- [x] **Step 2: Add failing five-tab workflow tests**
...
- [x] **Step 1: Add red transport assertions**
...
- [x] **Step 1: Add red interaction tests**
...
- [x] **Step 2: Implement local inbox filtering**
...
- [x] **Step 3: Extract typed timeline rendering**
...
- [x] **Step 4: Extract contextual reply composer**
...
- [x] **Step 1: Add red file workflow tests**
...
- [x] **Step 2: Implement browser state**
...
- [x] **Step 3: Implement mutation action sheet**
...
- [x] **Step 2: Implement task review surface**
...
- [x] **Step 3: Implement worker detail sheet**
...
- [x] **Step 1: Add red notification/settings tests**
...
- [x] **Step 2: Implement notification inbox**
...
- [x] **Step 4: Perform emulator smoke**
